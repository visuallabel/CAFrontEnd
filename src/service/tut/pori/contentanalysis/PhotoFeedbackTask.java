...
public class PhotoFeedbackTask extends AsyncTask{
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		executeAddTask(EnumSet.of(Capability.PHOTO_ANALYSIS, Capability.USER_FEEDBACK), ServiceInitializer.getDAOHandler().getDAO(PhotoTaskDAO.class), getTaskId(context.getMergedJobDataMap()));
	}
