...
public class VideoBackendFeedbackTask extends VideoFeedbackTask {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		executeAddTask(EnumSet.of(Capability.VIDEO_ANALYSIS, Capability.BACKEND_FEEDBACK), ServiceInitializer.getDAOHandler().getDAO(VideoTaskDAO.class), getTaskId(context.getMergedJobDataMap()));
	}
