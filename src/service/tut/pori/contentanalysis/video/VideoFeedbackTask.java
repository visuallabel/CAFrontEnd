...
public class VideoFeedbackTask extends AsyncTask{
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		executeAddTask(EnumSet.of(Capability.VIDEO_ANALYSIS, Capability.USER_FEEDBACK), ServiceInitializer.getDAOHandler().getDAO(VideoTaskDAO.class), getTaskId(context.getMergedJobDataMap()));
	}
