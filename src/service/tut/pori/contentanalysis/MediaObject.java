...
/**
 * <p>A class that defines a single media object. All media objects are by default of type {@link core.tut.pori.utils.MediaUrlValidator.MediaType#UNKNOWN}}.</p>
 * 
 * <p>Note: when using this class, never pass partial objects to database methods, missing information 
 * (e.g. value == null) may be assumed to be marked as "deleted", and will be removed from the database.</p>
 * 
 * <p>Media objects are objects which were identified from the content given for analysis (e.g. from photos).</p>
 * 
 * <p>Back-ends may only edit objects which have been created by them (checked by objectId, {@link #getObjectId()} and backendId, {@link #getBackendId()}). Back-ends may not edit objects which have been confirmed by the user.</p>
 * 
 * <p>If a back-end wants to modify an object created by another back-end, it must generate and submit a new ({@link service.tut.pori.contentanalysis.MediaObject.ConfirmationStatus#CANDIDATE}) media object.</p>
 * 
 ...
 *  <li>{@value service.tut.pori.contentanalysis.Definitions#ELEMENT_CONFIDENCE}, missing value means that the confidence is unknown.</li>
