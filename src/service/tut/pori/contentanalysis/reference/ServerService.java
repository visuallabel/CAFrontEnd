 ...
 *
 */
@HTTPService(name = service.tut.pori.contentanalysis.reference.Definitions.SERVICE_CA_REFERENCE_SERVER)
public class ServerService {
	 ...
	 * <h2>Example Query:</h2>
	 *
	 * POST /rest/{@value service.tut.pori.contentanalysis.reference.Definitions#SERVICE_CA_REFERENCE_SERVER}/{@value service.tut.pori.contentanalysis.Definitions#METHOD_TASK_FINISHED}<br>
	 * Content-Type: text/xml; charset=UTF-8<br><br>
	 *
	 * <b>[HTTP BODY STARTS]</b><br>
	 * 
	 * {@doc.restlet service="[service.tut.pori.contentanalysis.reference.Definitions#SERVICE_CA_REFERENCE_EXAMPLE]" method="[service.tut.pori.contentanalysis.Definitions#ELEMENT_TASK_RESULTS]" type="GET" query="" body_uri=""} <br>
	 * 
	 * <b>[HTTP BODY ENDS]</b><br>
	 *
	 * <h2>Example Result:</h2>
	 * 
	 * {@doc.restlet service="[service.tut.pori.contentanalysis.reference.Definitions#SERVICE_CA_REFERENCE_SERVER]" method="[service.tut.pori.contentanalysis.Definitions#METHOD_TASK_FINISHED]" type="POST" query="" body_uri="[service.tut.pori.contentanalysis.reference.Definitions#SERVICE_CA_REFERENCE_EXAMPLE]/[service.tut.pori.contentanalysis.Definitions#ELEMENT_TASK_RESULTS]"}
	 * 
	 * @param xml Only the result data should be in the body. See {@link service.tut.pori.contentanalysis.PhotoTaskResponse}
	 */
	...
	public void taskFinished(@HTTPMethodParameter(name = InputStreamParameter.PARAMETER_DEFAULT_NAME, bodyParameter = true) InputStreamParameter xml) {
		try {
			...
			try(InputStream input = IOUtils.toInputStream(body)){ // convert back to stream for unmarshal
				CAReferenceCore.taskFinished(_formatter.toObject(input, PhotoTaskResponse.class));
			}
	 ...
	 * <h2>Example Query:</h2>
	 *
	 * GET /rest/{@value service.tut.pori.contentanalysis.reference.Definitions#SERVICE_CA_REFERENCE_SERVER}/{@value service.tut.pori.contentanalysis.Definitions#METHOD_QUERY_TASK_DETAILS}?{@value service.tut.pori.contentanalysis.Definitions#PARAMETER_TASK_ID}=1&amp;{@value service.tut.pori.contentanalysis.Definitions#PARAMETER_BACKEND_ID}=1<br>
	 *
	 * <h2>Example Result:</h2>
	 * 
	 * {@doc.restlet service="[service.tut.pori.contentanalysis.reference.Definitions#SERVICE_CA_REFERENCE_SERVER]" method="[service.tut.pori.contentanalysis.Definitions#METHOD_QUERY_TASK_DETAILS]" type="GET" query="[service.tut.pori.contentanalysis.Definitions#PARAMETER_TASK_ID]=1&[service.tut.pori.contentanalysis.Definitions#PARAMETER_BACKEND_ID]=1" body_uri=""}
	 * 
	 * @param taskId
	 * @param backendId used to provide custom task details for specific back-ends
	...
	{
		return CAReferenceCore.queryTaskDetails(backendId.getValue(), taskId.getValue(), dataGroups, limits);
	}
}
