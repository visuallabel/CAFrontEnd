...
public class UserService {
	 ...
	 * 
	 * @param xml Details of the new user. See {@link service.tut.pori.users.UserCore.Registration}
	 * @return response
	 */
	 ...
	 * 
	 * @param authenticatedUser
	 * @param userIdFilter If parameter is missing, details for the authenticated user will be returned. Normal users only have permissions to their own accounts, an attempt to access details for other users will result in error.
	 * @return See {@link service.tut.pori.users.UserIdentityList}
	 */
