	...
	public static StringData generateSubtitles(UserIdentity authenticatedUser, String guid, FileFormat fileFormat, SubtitleFormat subtitleFormat, long[] userIdFilter) throws IllegalArgumentException {
		...
		switch(fileFormat){
			case WEBVTT:
				...
				VideoList videos = ServiceInitializer.getDAOHandler().getDAO(VideoDAO.class).search(authenticatedUser, DATA_GROUP_TIMECODES, Arrays.asList(guid), null, null, null, userIdFilter);
