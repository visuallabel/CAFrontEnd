...
/**
 * File service reference definitions
 * 
 */
public final class Definitions {
	/* services */
	/** service name declaration */
	public static final String SERVICE_FS_REFERENCE_CLIENT = "fsrc";
	/** service name declaration */
	public static final String SERVICE_FS_REFERENCE_EXAMPLE = "fsre";
