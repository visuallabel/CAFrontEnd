...
public class XMLFormatter {
	 ...
	 * @param string
	 * @param cls
	 * @return the object or null if bad/null/empty string
	 ...
	 * @param in
	 * @param cls
	 * @return the object or null if bad/null in
	 * @throws IllegalArgumentException on bad xml
	 */
	@SuppressWarnings("unchecked")
	 ...
	 */
	public String toString(Response r){
		String retval = null;
		try {
	 ...
	 * @throws IllegalArgumentException on bad xml
	 */
	public Response toResponse(InputStream in, Class<?> dataClass) throws IllegalArgumentException{
		if(in == null){
			return null;
		}
